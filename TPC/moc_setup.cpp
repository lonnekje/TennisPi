...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Setup_t, stringdata) + ofs \
...
void Setup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Setup::*_t)(int , QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Setup::valueChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Setup::staticMetaObject = {
    { &Button::staticMetaObject, qt_meta_stringdata_Setup.data,
      qt_meta_data_Setup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Setup.stringdata))
...
// SIGNAL 0
void Setup::valueChanged(int _t1, QImage _t2)
{
